...
<div class="grid_24">
    ...
    <div class="box_top">
        ...
        <h2 class="icon pages">Data Galeri</h2>
                ...
                <table class="sorting">
                    ...
                    <tbody>
                        ...
                        if(isset ($id)) {
							...
							<td class=\"align_left center\">$r->judulG</td>
                                                        
                                                        <td class=\"align_left center\">";echo word_limiter($r->isiG, 20)."</td>
							<td class=\"align_left center\"><a class=\"view popup tip\" href=\"$url$up$r->gambarG\" title=\"View Gambar\">view</a></td>
							<td class=\"align_left tools center\">
								<a href=\"dataGaleri/getById/$r->idgalery\" class=\"edit tip\" title=\"edit\">edit</a>";?>


                    <a href="<?php echo base_url();?>index.php/data/dataGaleri/delete/<?php echo $r->idgalery?>" class="delete tip" title="delete" onclick="return confirm('Apakah anda ingin menghapus data ini?')">delete</a>
                            <?php echo "</td>
						</tr>";
