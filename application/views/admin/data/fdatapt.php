...
<div class="grid_24">
    ...
    <div class="box_top">
        ...
        <h2 class="icon pages">Data Paket Tour</h2>
                ...
                <table class="sorting">
                    ...
                    <tbody>
                        ...
                        if(isset ($id)) {
							...
							<td class=\"align_left center\">$r->namaPK</td>
                                                        <td class=\"align_left center\">";echo word_limiter($r->isiPK, 20)."</td>
                                                   
							<td class=\"align_left tools center\">
								<a href=\"dataPt/getById/$r->idPK\" class=\"edit tip\" title=\"edit\">edit</a>";?>


                    <a href="<?php echo base_url();?>index.php/data/dataPt/delete/<?php echo $r->idPK?>" class="delete tip" title="delete" onclick="return confirm('Apakah anda ingin menghapus data ini?')">delete</a>
                            <?php echo "</td>
						</tr>";
                ...
                <table class="sorting">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="align_left">No.</th>
                            <th class="align_left center">Packet Tour</th>
