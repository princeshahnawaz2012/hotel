...
<div class="grid_24">
    ...
    <div class="box_top">
        ...
        <h2 class="icon pages">Data Testimoni</h2>
                ...
                <table class="sorting">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="align_left center">Umur</th>
                            <th class="align_left center">Negara</th>
                    ...
                    <tbody>
                        ...
                        if(isset ($id)) {
							...
							<td class=\"align_left center\">$r->namaT</td>
                                                        <td class=\"align_left center\">$r->umurT</td>
                                        <td class=\"align_left center\">$r->negaraT</td>
                                                        <td class=\"align_left center\">";echo word_limiter($r->isiT, 20)."</td>
							<td class=\"align_left center\"><a class=\"view popup tip\" href=\"$url$up$r->gambarT\" title=\"View Gambar\">view</a></td>
							<td class=\"align_left tools center\">
								<a href=\"dataTestimoni/getById/$r->idtestimoni\" class=\"edit tip\" title=\"edit\">edit</a>
								";?><a href="<?php echo base_url();?>index.php/data/dataTestimoni/delete/<?php echo $r->idtestimoni?>" class="delete tip" title="delete" onclick="return confirm('Apakah anda ingin menghapus data ini?')">delete</a>
						<?php echo "</td>
						</tr>";
                ...
                <table class="sorting">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="align_left center">Age</th>
                            <th class="align_left center">Country</th>
