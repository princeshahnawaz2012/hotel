...
<?php if ($msg == "success") { ?>
    ...
    <div class="box_top">
        ...
        <h2 class="icon pages">Data Hotel</h2>
                ...
                <table class="sorting">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="align_left center">Url</th>
                            <th class="align_left center">Facilitas</th>
                    ...
                    <tbody>
                        ...
                        if(isset ($id)) {
							...
							<td class=\"align_left center\">$r->namaH</td>
                                                        <td class=\"align_left center\">$r->urlH</td>
                                                       <td class=\"align_left center\">";echo word_limiter($r->fasilitasH, 20)."</td>
							<td class=\"align_left center\"><a class=\"view popup tip\" href=\"$url$up$r->gambarH\" title=\"View Gambar\">view</a></td>
							<td class=\"align_left tools center\">
								<a href=\"dataHotel/getById/$r->idhotel\" class=\"edit tip\" title=\"edit\">edit</a>";?>


                    <a href="<?php echo base_url();?>index.php/data/dataHotel/delete/<?php echo $r->idhotel?>" class="delete tip" title="delete" onclick="return confirm('Apakah anda ingin menghapus data ini?')">delete</a>
							<?php echo "</td>
						</tr>";
