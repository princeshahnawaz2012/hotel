<div id="breadcrumb">
    ...
    <ul class="left">
        ...
        <li class="icon point_right active"><a href="<?php echo base_url(); ?>index.php/data/dataProfil">Profil</a></li>
...
<div class="grid_24">
    ...
    <div class="box_top">
        ...
        <h2 class="icon pages">Edit Profil</h2>
    ...
    <div class="box_content">
        ...
        <div class="tabs">
            ...
            <div id="listing" class="padding">
                ...
                echo form_open_multipart(base_url() . 'index.php/data/dataProfil/edit', $attributes);
                 if(isset ($en)) {
                    foreach ($en as $r) {?>
                <div class="field">
                    <label>About Us</label>

                    <textarea class="wysiwyg" name="aboutus"><?php echo $r->tentangP?></textarea>
                ...
                <div class="field">
                    ...
                    <textarea class="wysiwyg" name="contact"><?php echo $r->contactP?></textarea>
                          </div>

                <div class="field">
                    <label class="left">Peta</label>
                    <input type="text" name="peta" value="<?php echo $r->mapP ?>" class="left validate">
                     <input type="hidden" name="idprofil" value="<?php echo $r->idprofil ?>" class="left validate">
                    </div>
